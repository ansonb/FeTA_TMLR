...
"""
from nets.SBM_node_classification.load_net import gnn_model # import all GNNS
...
def train_val_pipeline(MODEL_NAME, dataset, params, net_params, dirs):
    ...
    model = gnn_model(MODEL_NAME, net_params, edge_features_present=False)
    ...
    from train.train_SBM_node_classification import train_epoch_sparse as train_epoch, evaluate_network_sparse as evaluate_network
    ...
    test_loss_lapeig, test_acc, g_outs_test = evaluate_network(model, device, test_loader, epoch)
    train_loss_lapeig, train_acc, g_outs_train = evaluate_network(model, device, train_loader, epoch)
