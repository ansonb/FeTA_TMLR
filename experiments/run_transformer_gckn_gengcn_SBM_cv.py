...
from transformer.models import DiffGraphTransformer, GraphTransformer, DiffGraphTransformerGenGCNSBM
...
def main():
    ...
    gckn_pos_encoder = GCKNEncoding(
        ...
        args.gckn_agg, args.gckn_normalize, global_pooling=None, dataset_name=dset_name)
