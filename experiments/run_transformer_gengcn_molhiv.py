...
from transformer.models import DiffGraphTransformer, GraphTransformer, DiffGraphTransformerGCN, DiffGraphTransformerGenGCNMolHiv
...
def main():
    ...
    if args.pos_enc is not None:
        model = DiffGraphTransformerGenGCNMolHiv(in_size=input_size,
                                     nb_class=nb_class,
