...
def main():
    ...
    train_dset = GraphDataset_v2(dset[train_fold_idx], n_tags, degree=True)
    ...
    print(train_dset[0])
    val_dset = GraphDataset_v2(dset[val_fold_idx], n_tags, degree=True)
    ...
    test_dset = GraphDataset_v2(dset[test_fold_idx], n_tags, degree=True)
