...
class SAN_NodeLPE(nn.Module):
    def __init__(self, net_params, edge_features_present=False, node_features_dim=1):
        ...
        self.layers.append(GraphTransformerLayer(gamma, GT_hidden_dim, GT_out_dim, GT_n_heads, full_graph, dropout, self.layer_norm, self.batch_norm, self.residual, edge_features_present=edge_features_present))
